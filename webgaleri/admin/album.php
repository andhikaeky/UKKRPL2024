                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit<?php echo $data['albumid']?>">Edit</button>
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapus<?php echo $data['albumid']?>">Hapus</button>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; UKK RPL 2024 | ANDHIKA EKY</p>
</footer>
